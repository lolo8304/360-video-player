 ...
 * 
 */
package com.lolo.secondscreen.sensor_fusion.orientationProvider;

import java.util.ArrayList;
import java.util.List;

import com.lolo.secondscreen.sensor_fusion.representation.MatrixF4x4;
...
public abstract class OrientationProvider implements SensorEventListener {
    ...
    public OrientationProviderDelegate delegate = new OrientationProviderDelegate() {
        @Override
