...
public class Quaternion extends Vector4f {
    ...
    public void setEulerAnglesDegree(Vector3f pitchRollYaw) {
        Vector3f radian = new Vector3f();
        radian.setPitchX((float) (pitchRollYaw.getPitchX() / 180.0 * PI));
        radian.setRollY((float) (pitchRollYaw.getRollY() / 180.0 * PI));
        radian.setYawZ((float) (pitchRollYaw.getYawZ() / 180.0 * PI));
        this.eulerianAngles = radian;
    }
    public void setEulerAngles(Vector3f pitchRollYaw) {
        this.eulerianAngles = pitchRollYaw;
    }
    /**
    ...
    public Vector3f toEulerAngles() {
        ...
        this.setEulerAngles(tempVector);
        return this.eulerianAngles;
    }
